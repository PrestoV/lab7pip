...
{
    var valueX = getValue(document.getElementsByName("value-x"), -3, 5, (element) => true);
    var valueY = getValue(document.getElementsByName("value-y"), -4, 4, (element) => element.style.boxShadow != "");
    var valueR = getValue(document.getElementsByName("value-r"), 1, 3, (element) => element.style.boxShadow != "");
...
function sendRequest(valueX, valueY, valueR)
{
    ...
    xhrequest.onreadystatechange = function()
    {
        if(this.readyState === 4 && this.status === 200)
        {
            ...
            plotDraw();
          //  document.getElementById("main-form").innerHTML = this.responseText;
        }
    }
}
